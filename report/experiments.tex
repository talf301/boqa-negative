...
%
In order to test our modification as outlined in \Section{subsec:modnetstruct},
...
\Section{subsubsec:icpsampexp} describe the models modified for the purposes
of this report.
...
distribution described in \Equation{eq:lpdhiddenmod1}, and the sampling
procedure described in \Section{subsubsec:psampmodel}.
%
...
distribution described in \Equation{eq:lpdhiddenmod1}. The sampling
procedure used is that described in \Section{subsubsec:icpsampexp}.
%
